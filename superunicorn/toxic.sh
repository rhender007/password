...
TOXIC_RULE="/mnt/c/Tools/hashcat/rules/T0XlC.rule"
...
hashcat -m 500 -a 0 -O -S --status --status-timer=10 "$HASHES_FILE" -r "$TOXIC_RULE" "$WORD_LIST_CLEAN_LESS_THAN_10" | tee -a "$log_file"
